...
//#endif
    ...
    private void fm_efcplay() {
        r.bx = (short) pw.efcdat;
        r.ax = (short) (pw.md[r.getBx() + 254].dat + pw.md[r.getBx() + 254 + 1].dat * 0x100);
        r.ax += r.getBx();
...
not_end_fmefc:
    ...
    private void mstart() {
        ...
        if ((pw.board2 | pw.adpcm) != 0) {
            if (pw.ademu != 0) {
                ...
                r.bx = (short) pw.part10; // offset part10	//PCMを
    ...
    private void play_init() {
        ...
        if (pw.md[r.getSi()].dat != (pw.max_part2 + 1) * 2) {
            r.bx = Common.GetLe16(pw.md, r.si + (2 * (pw.max_part2 + 1)));
            r.bx += r.getSi();
        ...
        do {
            ...
            r.bx++;
            r.ax = Common.GetLe16(pw.md, r.si); // ax = part start addr
            r.si += 2;
...
init_exit:
    ...
    private void data_init2() {
        ...
        pw.fmsel = r.al;
        pw.syousetu_lng = 96;
        r.ax = (short) pw.fm1_port1;
        pw.fm_port1 = r.getAx();
        r.ax = (short) pw.fm1_port2;
        pw.fm_port2 = r.getAx();
        r.al = pw._fm_voldown;
        pw.fm_voldown = r.al;
        ...
        do {
            if (pw.fm_effec_flag != 0) {
                ...
                if (pw.board2 == 0) {
                    ...
                    if (r.getCx() == 1 && r.bx == 2) break pd03;
                }
            }
            //pd02:;
            opnset();
...
mml_fin:
    ...
    //==============================================================================
    private void sel46() {
        r.ax = (short) pw.fm2_port1;
        pw.fm_port1 = r.getAx();
        r.ax = (short) pw.fm2_port2;
        pw.fm_port2 = r.getAx();
        pw.fmsel = 1;
    }
    ...
    private void fmmain() {
        r.si = (short) pw.partWk[pw.part_data_table[r.di]].address; // si = PART DATA ADDRESS
        if (r.getSi()  == 0) return;
...
mp0:
    ...
    private Supplier<Object> mp1() // DATA READ
    {
        do {
            ...
            // ELSE COMMANDS
            Object o = commands();
            while (o != null && (Supplier<Object>) o != this::mp1) {
                o = ((Supplier<Object>) o).get();
                if ((Supplier<Object>) o == this::mnp_ret)
                    return this::mnp_ret;
                if ((Supplier<Object>) o == this::porta_return)
...
mp_new:
    ...
    public void calc_q() {
        ...
        r.stack.push(r.getAx());
        r.al = pw.partWk[r.di].leng;
        r.ax = (short) (r.al * pw.partWk[r.di].qdatb);
        r.dl += r.ah;
        r.ax = r.stack.pop();
...
cq_zero:
    ...
    private Supplier<Object> fmmnp_1() {
        do {
            do {
                ...
                Object o = commands();
                while (o != null && (Supplier<Object>) o != this::fmmnp_1) {
                    o = ((Supplier<Object>) o).get();
                    if ((Supplier<Object>) o == this::mnp_ret) return this::mnp_ret;
                }
            ...
            pw.partWk[r.di].onkai = (byte) 0xff; // -1
            r.bx = pw.partWk[r.di].partloop;
            if ((r.bx & r.bx) == 0) return this::fmmnp_4;
            //    ; "L"があった時
            r.si = r.getBx();
            pw.partWk[r.di].loopcheck = 1;
            pw.partWk[r.di].loopCounter++;
    ...
    private Supplier<Object> mp1cp() {
        Object o = commandsp();
        while (o != null && (Supplier<Object>) o != this::mp1cp && (Supplier<Object>) o != this::mp1p) {
            o = ((Supplier<Object>) o).get();
            if ((Supplier<Object>) o == this::mnp_ret) return this::mnp_ret;
        }
    ...
    private Supplier<Object> psgmnp_1() {
        do {
            do {
                ...
                r.al = (byte) pw.md[r.si++].dat;
                if (r.al == 0x80) break;
                if (r.al < 0x80) break psgmnp_4;

                if (r.al != 0xda) break psgmnp_3; // Portament?
...
psgmnp_3:
                ...
                Object o = commandsp();
                while (o != null && (Supplier<Object>) o != this::psgmnp_1) {
                    o = ((Supplier<Object>) o).get();
                    if ((Supplier<Object>) o == this::mnp_ret)
                        return this::mnp_ret;
                    if ((Supplier<Object>) o == this::porta_returnp)
...
reom:
        ...
        r.ah = 0;
        r.ax += r.getAx();
        r.ax += (short) pw.radtbl; // KUMA: R part　のアドレステーブル0x00～最大0x7f分存在しうる
        r.bx = r.getAx();
        r.ax = (short) (pw.md[r.getBx()].dat + pw.md[r.bx + 1].dat * 0x100); // mov ax,[bx]
...
rhyms00:
        ...
        {
            int r = rhythmon();
            if (r == 1) break rhyms00; // KUMA: 1の(連続でコマンドを実行したい)場合はループ
            pw.checkJumpIndexBX = false;
            return;
        }
...
rf00:
    ...
    private int rhythmon() {
        ...
        while (o != null) {
            o = ((Supplier<Object>) o) (); // KUMA: コマンド実施
        }
...
r_nonmask:
        ...
        if (pw.board2 != 0) {
            ...
            do {
                r.carry = ((r.ax & 1) != 0);
                r.ax = (short) ((r.ax >> 1) | (r.carry ? 0x8000 : 0));
                if (r.carry) {
                    rshot();
                    break rsb200;
                }
...
roret:
    ...
    private void rshot() {
        if (pw.board2 != 0) {
            //rshot:;
            r.dx = (short) (pw.rhydat[r.getBx()] + pw.rhydat[r.bx + 1] * 0x100);
            byte x = r.dh;
            r.dh = r.dl;
            r.dl = x;
            r.bx++;
...
rshot00:
    ...
    public Supplier<Object> command00() {
        if (pw.cmd != null && pw.cmd.args != null && pw.cmd.args.size() > 2 && pw.cmd.args[2] is MmlDatum[])
        {
            for (MmlDatum md : (MmlDatum[]) pw.cmd.args[2]) {
...
//#if DEBUG
//            logger.log(Level.TRACE, String.format("bx:%d di:%d", r.bx, r.di));
//#endif

        Object o = pw.currentCommandTable[r.getBx()];

//#if DEBUG
//            if (o == null)
//                logger.log(Level.ERROR, String.format("bx:%d di:%d", r.bx, r.di));
//#endif
        return (Supplier<Object>) o;
    }
...
//#endif
        ...
        r.ax = (short) ((byte) pw.md[r.getSi()].dat + (byte) pw.md[r.si + 1].dat * 0x100);
        r.si += 2;
        if (r.getAx() == 0)
            break fm3ext_part3c;
        r.ax += (short) pw.mmlbuf;
...
fm3ext_exit:
    ...
    private void fm3_partinit() {
        ...
        pw.partWk[r.di].onkai_def = r.al; // rest
        pw.partWk[r.di].volume = 108; // FM VOLUME DEFAULT= 108
        r.bx = (short) pw.part3; // offset part3
...
//#endif
        ...
        if (pw.partWk[r.di].envf == 0xff)
            break not_set_count; // ノーマル＞拡張に移行したか？
...
//#endif
        ...
        r.al = (byte) pw.md[r.si++].dat;
        r.bl = r.al;
        r.ax = (short) (pw.md[r.getSi()].dat + pw.md[r.si + 1].dat * 0x100);
        r.si += 2;
...
pc_ret:
    ...
    private Supplier<Object> porta() {
        ...
        r.bh = (byte) ((r.bh & 0x80) | ((r.bh >> 1) & 0x7f));
        r.al = r.bh;
        r.ax = (short) (byte) r.al; // ax=octarb差
        r.bx = 0x26a;
...
not_octarb:
        ...
        r.bx &= 0x7ff;
        r.bx -= r.getCx();
        r.ax += r.getBx(); // ax=26ah* octarb差 + 音程差
        ...
        r.bh = 0;
        int src = (short) r.ax;
        r.dx = (short) (src % (short) r.bx); // ax=(26ah* ovtarb差 + 音程差) / 音長
...
porta_notset:
    ...
    private Supplier<Object> portap() {
        ...
        r.bh = 0;
        int src = (short) r.ax;
        r.dx = (short) (src % (short) r.bx); // ax = psg_tune差 / 音長
        r.ax = (short) (src / (short) r.bx);
        pw.partWk[r.di].porta_num2 = r.getAx(); // 商
        pw.partWk[r.di].porta_num3 = r.getDx(); // 余り
        pw.partWk[r.di].lfoswi |= 8; // Porta ON
...
//#endif
    ...
    private Supplier<Object> volupckp() {
        //IDE向け
        ChipDatum cd = new ChipDatum(-1, -1, -1);
        MmlDatum md = new MmlDatum(-1, MMLType.Volume, pw.cmd.linePos, Math.min((int) r.al, 15));
        cd.additionalData = md;
        WriteDummy(cd);
...
//#endif
        ...
        //IDE向け
        ChipDatum cd = new ChipDatum(-1, -1, -1);
        MmlDatum md = new MmlDatum(-1, MMLType.Volume, pw.cmd.linePos, Math.max((int) (r.al - 4), 0));
        cd.additionalData = md;
        WriteDummy(cd);
...
//#endif
        ...
        //IDE向け
        ChipDatum cd = new ChipDatum(-1, -1, -1);
        MmlDatum md = new MmlDatum(-1, MMLType.Volume, pw.cmd.linePos, Math.max((int) (r.al - r.ah), 0));
        cd.additionalData = md;
        WriteDummy(cd);
...
//#endif
        ...
        //IDE向け
        ChipDatum cd = new ChipDatum(-1, -1, -1);
        MmlDatum md = new MmlDatum(-1, MMLType.Volume, pw.cmd.linePos, Math.max((int) (r.al - 1), 0));
        cd.additionalData = md;
        WriteDummy(cd);
...
//#endif
        Object o = lfoswitch();
        while (o != null) o = ((Supplier<Object>) o) ();
        return this::ch3_setting;
    }
...
//#endif
        ...
        if (pw.partWk[r.di].envf != 0xff)
            break not_set_count2; // 拡張＞ノーマルに移行したか？
...
fnr_ret:
    ...
    private void fnumsetp() {
        ...
        r.bh = 0; // bx=onkai
        //r.bx += r.bx;
        r.ax = pw.psg_tune_data[r.getBx()];

        r.carry = r.cl == 0 ? false : ((r.getAx() & (1 << (r.cl - 1))) != 0);
        r.ax = (short) ((short) r.getAx() >> r.cl); //    shr ax,cl
...
od_00p:
        ...
        //	; PSG Portament set
        //	;
        r.ax = (short) ((short) r.ax + (short) pw.partWk[r.di].porta_num);
        //  ;
        //	; PSG Detune/LFO set
        //  ;
...
od_ext_lfo:
        ...
        r.dx = 0;
        if ((pw.partWk[r.di].lfoswi & 0x1) == 0)
            break od_ext_notlfo1;
        r.dx = pw.partWk[r.di].lfodat;
od_ext_notlfo1:
        ;
        if ((pw.partWk[r.di].lfoswi & 0x10) == 0)
            break od_ext_notlfo2;
...
ko1p:
        ...
        if (r.dl == pw.psnoi_last)
            break psnoi_ret; // ; 同じなら定義しない
        if ((pw.psgefcnum & 0x80) == 0)
            break psnoi_ret; // PSG効果音発音中は変更しない
        r.dh = 6;
        opnset44();
        pw.psnoi_last = r.dl;
psnoi_ret:
...
nss_notfm3:
    ...
    private void check_carrier() {
        ...
        if ((pw.partWk[r.di].volmask & 0xf) != 0)
            break not_set_volmask; // Volmask値が0以外の場合は設定しない
        pw.partWk[r.di].volmask = r.al;

not_set_volmask:
        ;
        if ((pw.partWk[r.di]._volmask & 0xf) != 0)
            break not_set_volmask2;
        pw.partWk[r.di]._volmask = r.al;
...
ns01:
        ;
        if (pw.inst != null && r.bx < pw.inst.length) r.dl = (byte) pw.inst[r.getBx()].dat;
        else r.dl = 0;
        r.bx++;
        r.carry = ((r.al & 0x80) != 0);
...
lfo1:
        ...
        if ((pw.partWk[r.di].extendmode & 2) == 0) // TimerAと合わせるか？
            break lfo_normal; // そうじゃないなら無条件にlfo処理
        r.ch = pw.TimerAtime;
...
lfo_check:
        ...
        if (r.getAx() != pw.partWk[r.di].lfodat)
            break lfo_stc_ret;
        return; // c=0
...
lfo2ns:
        ;
        r.ax = (short) ((byte) r.al * r.ah); // lfowave=5の場合 1step = step×｜step｜
        break lfo20;
...
lfo_kukei:
        ...
        // 矩形波 lfowave = 2
        r.al = pw.partWk[r.di].step;
        r.ax = (short) ((byte) r.al * (byte) pw.partWk[r.di].time);
        pw.partWk[r.di].lfodat = r.getAx();
        md_inc();
...
ns_plus:
        ;
        r.ax = (short) (r.al * pw.partWk[r.di].time);
        r.stack.push(r.getAx());
        r.stack.push(r.getCx());
        r.ax += r.getAx();
        rnd();
...
mdi22_ov:
    ...
    private void rnd() {
        ...
        r.cx = 32767;
        r.ax = (short) (ans / r.getCx());
        r.dx = (short) (ans % r.getCx());
...
li_00:
    ...
    private void lfo_exit() {
        if ((pw.partWk[r.di].lfoswi & 3) == 0) // LFO使用中か？
            break le_no_one_lfo1; // ; 前が & の場合 -> 1回 LFO処理
...
le_no_one_lfo1:
        ...
        if ((pw.partWk[r.di].lfoswi & 0x30) == 0) // LFO使用中か？
            break le_no_one_lfo2; // 前が & の場合 -> 1回 LFO処理
...
lim_nofirst:
    ...
    public void soft_env() {
        ...
        r.ch -= pw.lastTimerAtime;
        if (r.ch == 0)
            break senv_ret; // 前回の値と同じなら何もしない cy = 0
        r.cl = 0;
...
esm_main2:
    ...
    private void esm_sub() {
        ...
        r.al--;
        if ((r.al & 0x80) != 0)
            break arc_count_check; // 0以下の場合はカウントCHECK
        r.al++;
...
esm_dr_check:
        ...
        r.al--;
        if ((r.al & 0x80) != 0)
            break drc_count_check; // 0以下の場合はカウントCHECK
        r.al++;
...
esm_sr_check:
        ...
        r.al--;
        if ((r.al & 0x80) != 0)
            break src_count_check; // 0以下の場合はカウントCHECK
        r.al++;
        r.carry = pw.partWk[r.di].eenv_volume < r.al;
        pw.partWk[r.di].eenv_volume -= r.al;
        if (!r.carry)
...
esm_rr:
        ...
        r.al--;
        if ((r.al & 0x80) != 0)
            break rrc_count_check; // 0以下の場合はカウントCHECK
        r.al++;
        r.carry = pw.partWk[r.di].eenv_volume < r.al;
        pw.partWk[r.di].eenv_volume -= r.al;
        if (!r.carry)
...
ppz_off_loop:
    ...
    public short get_memo(int al) {
        try {
            ...
            r.si += 0x18;
            r.si = (short) (pw.md[r.getSi()].dat + pw.md[r.si + 1].dat * 0x100);
            r.si += (short) pw.mmlbuf;
            r.si -= 4;
            r.bx = (short) (pw.md[r.si + 2].dat + pw.md[r.si + 3].dat * 0x100); // bh=0feh,bl=ver
...
getmemo_oldver47:
            ;
            r.si = (short) (pw.md[r.getSi()].dat + pw.md[r.getSi() + 1].dat * 0x100);
            r.si += (short) pw.mmlbuf;
            r.al++;
getmemo_loop:
            ;
            r.dx = (short) (pw.md[r.getSi() + 0].dat + pw.md[r.getSi() + 1].dat * 0x100);
            if (r.getDx() == 0)
...
maskon_next:
        ...
        r.di += 1; // qq
        r.cx--;
        if (r.getCx() != 0) break maskon_loop;
        return;
    }
...
moffl_main:
        ...
        if (pw.partWk[r.di].partmask != 0)
            break maskoff_next; // まだ他でマスクされてる
...
maskoff_next:
        ...
        r.di += 1; // qq
        r.cx--;
        if (r.getCx() != 0) break maskoff_loop;
        return;
    }
...
pmppz_noexec:
    ...
    private void maskoff_main() {
        if (r.ah == 0)
            break po_fm1; // FM音源の場合は
        if (pw.board2 != 0) {
            r.ah--;
            if (r.ah == 0) break po_fm2; // 音色設定処理
        }
...
not_e_flag:
        ...
        r.bx += r.getBx();
        r.bx += (short) pw.efcdat;
        r.ax = (short) (pw.md[r.getBx()].dat + pw.md[r.getBx() + 1].dat * 0x100);
        r.ax += (short) pw.efcdat;
...
not_fade:
        ...
        if (pw.ppsdrv_flag == 0)
            break ta_not_ppsdrv;
        if ((pw.psgefcnum & 0x80) != 0)
            break not_psgeffec; // ppsdrvの方で鳴らしている
ta_not_ppsdrv:
        ;
...
opninit_exec:
                ...
                if (r.al != pw.opn_0eh) // int番号を比較
                    break opninit_next; // ; 非一致なら初期化しない
...
ppzchk_end:
    ...
    private void opnint_start() {
        if (pw.board == 0)
            break not_opnint_start; // ; ボードがない

        //r.ax = r.cs;
        //r.es = r.ax;
        r.di = (short) pw.part1;
        r.cx = (short) pw.max_part1; // max_part1*type qq
        r.al = 0;
        do {
            pw.partWk[r.di++].Clear();
            r.cx--;
...
not_opnint_start:
    ...
    private void set_option(String[] pmdOption) {
        ...
        for (int i = 0; i < pmdOption.length; i++) {
            ...
            if (op.length() < 1 || (op.charAt(0) != '/' && op.charAt(0) != '-')) continue;
